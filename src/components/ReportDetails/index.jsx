                ...
                <Row>
                    <Col span={12}>
                        <p>
                            ...
                            <span><strong>Time: </strong>12:24 PM</span><br/>
                            <span><strong>Approve By: </strong>Rahajul Amin Shuvo</span><br/>
                        </p>
                    </Col>
                    <Col span={12} style={{textAlign:'right'}}>
                        <p>
                            <span><strong>Page No: </strong> 4</span><br/>
                            <span><strong>Column No: </strong> 5</span><br/>
                            <span><strong>Size: </strong>14"X20"</span><br/>
                        </p>
                    </Col>
                </Row>
                <Space/>
